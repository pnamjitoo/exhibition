 ...
 * Generated at: 2022-09-12 14:43:35 UTC
...
public final class itemInfo_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("    <link href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/css/itemInfo.css?ver=1\" rel=\"stylesheet\">\r\n");
      out.write("\r\n");
      out.write("</head>\r\n");
      out.write("<!-- 아이템 리스트 불러오는 ajax 통신 ------------------------------->\r\n");
      ...
      out.write("    	\r\n");
      out.write("    	//아이템 호출//\r\n");
      out.write("    	var item_no = getParameterByName('item_no');\r\n");
      out.write("    	var url = \"/exhibition/ItemServlet?command=item_view&item_no=\" + item_no\r\n");
      out.write("		$.ajax({\r\n");
      out.write("	        type : \"POST\",\r\n");
      out.write("	        url : url,\r\n");
      ...
      out.write("                    var itemList = JSON.parse(JSON.stringify(item[0]));\r\n");
      out.write("                    console.log(itemList);\r\n");
      out.write("                    console.log(JSON.stringify(itemList[\"item_no\"]));\r\n");
      out.write("                    var item_no = itemList[\"item_no\"].toString();\r\n");
      out.write("                    var item_name = itemList[\"item_name\"].toString();\r\n");
      out.write("                    var price = itemList[\"price\"].toString();\r\n");
      out.write("                    var benefit = itemList[\"benefit\"].toString();\r\n");
      out.write("                    var sale = itemList[\"sale\"].toString();\r\n");
      out.write("                    var num = itemList[\"num\"].toString();\r\n");
      out.write("                    var item_content = itemList[\"item_content\"].toString();\r\n");
      out.write("                    var place = itemList[\"place\"].toString();\r\n");
      out.write("                    var location = itemList[\"location\"].toString();\r\n");
      out.write("                    var likes = itemList[\"likes\"].toString();\r\n");
      out.write("                    var hits = itemList[\"hits\"].toString();\r\n");
      out.write("                    var opendate = itemList[\"opendate\"].toString();\r\n");
      out.write("                    var closedate = itemList[\"closedate\"].toString();\r\n");
      out.write("                    var item_photo = itemList[\"item_photo\"].toString();\r\n");
      out.write("                    var runtime = itemList[\"runtime\"].toString();\r\n");
      out.write("                    var item_age = itemList[\"item_age\"].toString();\r\n");
      out.write("                    var item_rdate = itemList[\"item_rdate\"].toString();\r\n");
      out.write("                    var tema_no = itemList[\"tema_no\"].toString();\r\n");
      out.write("	                $(\"#item_index\").html(item_name + \"<span>\" + hits + \"</span><span id=\\\"count\\\">조회수 :</span><span>\" + item_rdate + \"</span><span id=\\\"add\\\">등록날짜 :</span>\");\r\n");
      out.write("	                $(\"#item_img\").html(\"<img src=\\\"\" + item_photo + \"\\\">\");\r\n");
      out.write("	                $(\"#item_text\").html(\"<div class=\\\"head\\\">이름</div><div class=\\\"text\\\">\" + item_name + \"</div><div class=\\\"head\\\">지역</div><div class=\\\"text\\\">\" + location + \"</div><div class=\\\"head\\\">개최장소</div><div class=\\\"text\\\">\"+place+\"</div><div class=\\\"head\\\">가격</div><div class=\\\"text\\\">\" + price + \"원</div><div class=\\\"head\\\">할인율</div><div class=\\\"text\\\">\" + sale + \"%</div><div class=\\\"head\\\">혜택</div><div class=\\\"text\\\">\"+benefit+\"</div><div class=\\\"head\\\">재고</div><div class=\\\"text\\\">\" + num + \"매</div><div class=\\\"head\\\">관람시간</div><div class=\\\"text\\\">\"+runtime+\"</div><div class=\\\"head\\\">관람연령</div><div class=\\\"text\\\">\"+item_age+\"</div><div class=\\\"head\\\">개장날짜</div><div class=\\\"text\\\">\" + opendate + \"</div><div class=\\\"head\\\">종료날짜</div><div class=\\\"text\\\">\" + closedate + \"</div><div id=\\\"fav\\\">좋아요 : <span>\" + likes + \"</span></div>\");\r\n");
      out.write("	                $(\"#info\").html(\"<img src=\\\"\" + item_content + \"\\\">\");\r\n");
      out.write("	            });\r\n");
      out.write("	        }\r\n");
      out.write("	    });\r\n");
      out.write("    });\r\n");
...
if (session.getAttribute("loginUser") == null) {
      ...
      out.write("    \r\n");
      out.write("    <main>\r\n");
      out.write("        <h2 id=\"item_index\">\r\n");
      out.write("<!--             전시회이름 \r\n");
      out.write("            <span>1</span>\r\n");
      out.write("            <span  id=\"count\">조회수 :</span>\r\n");
      out.write("            <span>2020.09.13</span>\r\n");
      out.write("            <span id=\"add\">등록날짜 :</span> -->\r\n");
      out.write("        </h2>\r\n");
      out.write("        <div id=\"item_img\">\r\n");
      out.write("\r\n");
      out.write("        </div>\r\n");
      out.write("        <div id=\"item_text\">\r\n");
      ...
      out.write("            </div>//text\r\n");
      out.write("            <div id=\"fav\">\r\n");
      out.write("                좋아요 : <span>1</span>\r\n");
      out.write("            </div> -->\r\n");
      out.write("        </div><!--//item_text-->\r\n");
      out.write("        <div id=\"item_info\">\r\n");
      out.write("<!--             <h2>전시회설명</h2>\r\n");
      out.write("            <div  class=\"info\">\r\n");
      out.write("                이 전시회는 ...\r\n");
      out.write("            </div>//info -->\r\n");
      out.write("        </div><!--//item_info-->\r\n");
      out.write("        <div id=\"rev_photo\">\r\n");
      out.write("            <h2>리뷰사진</h2>\r\n");
      out.write("            <ul>\r\n");
      out.write("                <li></li>\r\n");
      out.write("                <li></li>\r\n");
      out.write("                <li></li>\r\n");
